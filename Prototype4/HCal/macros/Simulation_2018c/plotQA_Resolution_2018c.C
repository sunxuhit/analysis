...
void plotQA_Resolution_2018c()
{
  ...
  TGraphAsymmErrors *g_resolution_2018c_simulation = (TGraphAsymmErrors*)File_2018c_simulation->Get("g_resolution_2018c_pion");
  ...
  g_resolution_2018c_simulation->SetMarkerStyle(24);
  g_resolution_2018c_simulation->SetMarkerColor(4);
  g_resolution_2018c_simulation->SetMarkerSize(2.0);
  g_resolution_2018c_simulation->Draw("pE same");

  g_resolution_2017_pion->SetMarkerStyle(25);
  ...
  leg_linear->AddEntry(g_resolution_2018c_simulation,"#pi- Sim EMCal+OHCal","p");
