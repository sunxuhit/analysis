...
{
  string input_pion = Form("/gpfs/mnt/gpfs02/sphenix/user/xusun/Simulation/ShowerCalibAna/Proto4Simulation_2018c_pion_%dGeV.root",mEnergy);
  TFile *File_InPut_pion = TFile::Open(input_pion.c_str());
  TH2F *h_mAsymmEnergy_pion_before = (TH2F*)File_InPut_pion->Get("h_mAsymmEnergy_balancing");
  TH2F *h_mAsymmEnergy_pion_after = (TH2F*)File_InPut_pion->Get("h_mAsymmEnergy_leveling");

  string input_electron = Form("/gpfs/mnt/gpfs02/sphenix/user/xusun/Simulation/ShowerCalibAna/Proto4Simulation_2018c_electron_%dGeV.root",mEnergy);
  TFile *File_InPut_electron = TFile::Open(input_electron.c_str());
  TH2F *h_mAsymmEnergy_electron_before = (TH2F*)File_InPut_electron->Get("h_mAsymmEnergy_balancing");
  TH2F *h_mAsymmEnergy_electron_after = (TH2F*)File_InPut_electron->Get("h_mAsymmEnergy_leveling");
  ...
  c_AsymmEnergy->SaveAs("./figures/c_SimEnergyBalancing_12GeV.eps");
}
