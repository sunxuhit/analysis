...
{
  string inputfile = "/gpfs/mnt/gpfs02/sphenix/user/xusun/TestBeam/ShowerCalibAna_2018c/Proto4ShowerCalib_12GeV_2018c.root";
  ...
  h_mEnergy_electron->GetYaxis()->SetRangeUser(0,h_mEnergy_pion->GetMaximum()*1.3);
  ...
  f_gaus_electron->SetRange(22.0,32.0);
  ...
  c_Energy->SaveAs("../figures/HCAL_ShowerCalib_2018c/c_RatioEPi_2018c.eps");
}
