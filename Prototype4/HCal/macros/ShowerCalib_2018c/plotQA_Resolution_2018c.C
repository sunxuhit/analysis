...
void plotQA_Resolution_2018c()
{
  ...
  g_resolution_2018a_electron->SetMarkerStyle(20);
  g_resolution_2018a_electron->SetMarkerColor(4);
  ...
  */
  ...
  // leg_linear->AddEntry(g_resolution_2018a_electron,"e- T1044-2018a","p");
  leg_linear->Draw("same");

  c_Resolution->SaveAs("../figures/HCAL_ShowerCalib_2018c/c_Resolution_2018c.eps");
}
