...
void plotQA_BalancedElectronEnergy()
{
  ...
  c_AsymmEnergy->SaveAs("../figures/HCAL_ShowerCalib_2018c/c_EnergyAsymmBalancing_electron_2018c.eps");
  ...
  c_Energy->SaveAs("../figures/HCAL_ShowerCalib_2018c/c_EnergyBalancing_electron_2018c.eps");
}
